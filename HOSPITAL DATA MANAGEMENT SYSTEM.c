...
{
    printf("\n\n");
    printf("Existing data on the database =%d\n\n",num);
    printf("How many entries would you want to add=\n");
    scanf("%d",&n);
    sum=n+num;
...
void edit()
{
    int q,p;
    fflush(stdin);
    printf("Choose the option you would like to edit ?\n");
...
void search()
{
    int s,h,f;
    char u[100];
    printf("Choose the option you would like to search on?\n");
    printf("1.Serial no.\n2.Name\n3.Disease\n4.Cabin no.\n5.Phone no.\n6.Age\n\nOption = ");
    scanf("%d",&h);
    if(h==1)
    {
